...
<script type="text/javascript">
	function validation(){
		...
		if(name!=null && email!=null && mobile!=null && pass!=null && name!="" && email!="" && mobile!="" && pass!=""&&name.length>0 && email.length>0 && mobile.length==10&&pass.length>0){
			...
			document.getElementById("errormess").innerHTML = "Lutfen degerleri dogru giriniz";
			return false;
		}
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="Login.jsp" id="login-form-link">Giris Yap</a>
							</div>
							<div class="col-xs-6">
								<a href="#" class="active"  id="register-form-link">Kayit Ol</a>
							</div>
						</div>
						<hr>
					</div>
							...
							<div class="col-lg-12">
								<form action="../Register" method="post" onsubmit="return validation()" id="login-form" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="name" id="name" tabindex="1" class="form-control" placeholder="isim" >
									</div>
									<div class="form-group">
										<input type="text" name="email" id="email" tabindex="2" class="form-control" placeholder="Email ID" >
									</div>
									<div class="form-group">
										<input type="password" name="password" id="password" tabindex="3" class="form-control" placeholder="Sifre" >
									</div>
									<div class="form-group">
										<input type="number" name="mobile" id="mobile" tabindex="4" class="form-control" placeholder="Telefon" >
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register" id="login-submit" tabindex="5" class="form-control btn btn-login" value="Kayit Ol">
											</div>
										</div>
									</div>

							...
							<div class="col-sm-4">
			    				...
			    				<div class="form-group">
			    					<select id="roomType" class="form-control">
			    						<option value="AC">Klimali</option>
			    						<option value="Non-AC">Klima yok</option>
			    					</select>
			    				</div>
			    				<div class="form-group">
			    				Oda boyutu sec:
			    				...
			    				<div class="form-group" >
			    					<select id="roomSize" class="form-control">
			    						<option value="single">Tek kisilik</option>
			    						<option value="double">Cift kisilik</option>
			    					</select>
			    				</div>
			    				<div class="form-group">
			    				Fiyat gir:
			    				...
			    				<div class="form-group">
			    					<div class="text-right"> 
			    						<input type="button" id="button" value="Oda Ekle" class="btn btn-primary">
			    					</div>
			    				</div>

...
<title>Indirim Degistir/Sil</title>
</head>
<body>
			    			...
			    			<div class="col-sm-8">
			    				<div class ="col-sm-4">
			    					<div class="form-group">
					    				...
					    				<input type="button" id="modify" value="Degistir" class="btn btn-primary">
					    				</div>
					    			</div>
				    			</div>	
				    			<div class ="col-sm-3">
				    				<div class="form-group">
				    					<input type="button" id="delete" value="Sil" class="btn btn-primary">
					    			</div>
				    			</div>
			    				<div class ="col-sm-2">
			    					<div class="form-group">
			    						<div class="text-left">
			    						<input type="button" id="update" value="Guncelle" class="btn btn-primary">
			    						</div>
			    					</div>
			    				</div>
			    			</div>

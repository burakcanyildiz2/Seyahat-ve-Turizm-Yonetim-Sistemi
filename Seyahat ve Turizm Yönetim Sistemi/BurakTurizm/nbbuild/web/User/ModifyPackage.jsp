...
<title>Paketi Iptal Et/Degistir</title>
</head>
<body>
...
<%@ include file ="Aside.jsp" %>
	<section class="section">
		...
		<h2>Paketi Iptal Et/Degistir</h2>
					...
					<%
					  try {
						  Class.forName("com.mysql.cj.jdbc.Driver");
					    	...
					    	<td><a href="../ModifyPackage?package=<%=rs.getString(1) %>&place=<%=rs.getString(2)%>">Degistir</a></td>
					    	<td><a href="../CancelPackage?package=<%=rs.getString(1) %>&place=<%=rs.getString(2)%> ">Iptal Et</a></td>
					    	</tr>
					    	<%} %>
					    	<% 
					    	}

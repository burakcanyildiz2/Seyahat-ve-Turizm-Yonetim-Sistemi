				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism?useUnicode=true&useLegacyDatetimeCode=false&serverTimezone=Turkey","root","1234");
								...
								Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism?useUnicode=true&useLegacyDatetimeCode=false&serverTimezone=Turkey","root","1234");
								...
								Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism?useUnicode=true&useLegacyDatetimeCode=false&serverTimezone=Turkey","root","1234");
								...
								Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism?useUnicode=true&useLegacyDatetimeCode=false&serverTimezone=Turkey","root","1234");
								...
								%>
								<td><%=totalcost %></td>
								<td><a href="Payment.jsp?id=<%=id%>&total=<%=totalcost %>&packagename=<%=packagename%>&place=<%=place%>">Öde</a><td>
								<%
							}
						}
						catch(Exception e){

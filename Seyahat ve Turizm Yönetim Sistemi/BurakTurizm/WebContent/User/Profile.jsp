			    	...
			    	<div class="row">
			    		<div class="col-sm-4">
			    			...
			    			<%try{
			    				...
			    				<div class="form-group">
			    					<input class="form-control" type="text" id="mobile" name="mobile" required="true" value ="<%
                           ...
                           %>">
			    				...
			    				<div class="form-group">
			    					<div class="text-right"> 
			    						<input type="button" id="button" value="Guncelle" class="btn btn-primary">
			    					</div>
			    				</div>

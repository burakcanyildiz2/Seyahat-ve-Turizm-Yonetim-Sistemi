...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Ulasim Rezervasyon</title>
</head>
<body>
				...
				<tbody>
					<%
					  try{
					    	...
					    	<td><a href="../UpdateTransport?transportType=<%=rs.getString(1) %>&vehicleType=<%=rs.getString(2)%>&vehicleName=<%=rs.getString(3)%>&type=book ">Rezervasyon</a></td>
					    	</tr>
					    	<%} %>
					    	<% 
					    	}
